...
<form action="${pageContext.request.contextPath }/add.udo" class="layui-form" id="regform" style="padding:30px;">
	...
	<div class="layui-form-item">
		<div class="layui-input-block">
			<button type="submit" class="layui-btn" lay-submit="" lay-filter="regsub">注册</button>
...
layui.use('form', function(){
  ...
  form.on('submit(regsub)', function (data) {
		...
		$.ajax({
			type: 'POST',
			url: '${pageContext.request.contextPath }/add.udo', //请求路径
